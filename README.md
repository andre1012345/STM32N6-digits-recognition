...
This project provides a real-time embedded environment for STM32N6 microcontroller to execute [STEdgeAI](https://www.st.com/en/development-tools/stedgeai-core.html) generated models, specifically targeting the image classification application. The code prioritizes clarity and understandability over performance, making it an ideal starting point for further development.
...
2. Program `Binary/STM32N6570-DK/STM32N6570-DK_GettingStarted_ImageClassification.hex`.
3. Set the board to [boot from flash mode](#boot-modes).
4. Power cycle the board.
5. Place a dish from the [Food 101 Dataset](https://www.kaggle.com/datasets/dansbecker/food-101) in front of the camera to identify it.
...
1. Set the board to [development mode](#boot-modes).
2. Program `Binary/NUCLEO-N657X0-Q/USB-UVC-Display/NUCLEO-N657X0-Q_GettingStarted_ImageClassification-uvc.hex`.
3. Set the board to [boot from flash mode](#boot-modes).
...
7. Place a flower from the [Flowers Dataset](https://www.kaggle.com/datasets/imsparsh/flowers-dataset) in front of the camera to identify it.
...
1. Set the board to [development mode](#boot-modes).
2. Program `Binary/NUCLEO-N657X0-Q/SPI-Display/NUCLEO-N657X0-Q_GettingStarted_ImageClassification-spi.hex`.
3. Set the board to [boot from flash mode](#boot-modes).
4. Power cycle the board.
5. Place a flower from the [Flowers Dataset](https://www.kaggle.com/datasets/imsparsh/flowers-dataset) in front of the camera to identify it.
...
STM32_Programmer_CLI -c port=SWD mode=HOTPLUG -el $DKEL -hardRst -w Binary/STM32N6570-DK/STM32N6570-DK_GettingStarted_ImageClassification.hex
```
...
# USB/UVC
STM32_Programmer_CLI -c port=SWD mode=HOTPLUG -el $NUEL -hardRst -w Binary/NUCLEO-N657X0-Q/USB-UVC-Display/NUCLEO-N657X0-Q_GettingStarted_ImageClassification-uvc.hex
