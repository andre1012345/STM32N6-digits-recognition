...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "mnist_cnn_32x321_PerChannel_quant_mnist_calib_1_npz_1"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (3072)

/************************** OUTPUTS *******************************************/
#define LL_ATON_NETWORK_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Quantize_25_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (10)
